...
/*Всплывающий блок*/
$(document).ready(function(){
    $('.flat__single').hover(function(){
        $('.flat__single').append('<div class="flat__single-descr"><p>Однокомнатная квартира</p><p class="flat__single-descr-p">Свободна</p><div class="flat__single-descr-img"><img src="images/flat.png" alt="однокомнатная"></div><div><span class="g-float_left">34.40 м2</span><span class="g-float_right">1 200 000 ₽</span></div></div>')
});
});
